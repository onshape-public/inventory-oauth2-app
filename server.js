...
// Create endpoint handlers for /parts
router.route("/parts-list").get(authController.isAuthenticated, (req, res) => {
...
router.route("/nextpartnumbers").post(partNumberController.incrementPartNumber);
...
router.route("/users/create-admin-user").post(userController.createAdminUser);
